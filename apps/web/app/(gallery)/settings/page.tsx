...
//
// FD1: this file lives under `(gallery)` — the branch that wears AppShell — rather than at
...
//
// FD2: the workspace seed runs at THIS boundary too, not only at `/` and `/organisms`. A bookmark
...
export default function SettingsRoute() {
  ...
  // useDocumentTitle either (FD5): Battles and Organisms claim no document.title, and Settings
  // follows them.
  return (
    <SettingsPage
