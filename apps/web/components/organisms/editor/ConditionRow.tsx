 ...
 * every error regardless of `touched` once a Save has been attempted, and stays on across value
 * edits (4.13 FD3): a new ROW added after a refusal un-sticks it (a structural add), but a
 * property/operator switch on an existing row is a value edit, so after the first refusal that
 * `touched` reset is a no-op and the switched-in numeric input opens red until it is valid — the
 * residual 4.13's owner accepted with option (c).
 *
