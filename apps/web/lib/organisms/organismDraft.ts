 ...
 * `dominance`, 4.7 `agingEnabled`/`colorToken` and 4.8's M6 colour seed are done; 4.10 adds
 ...
 * record. A fresh object per call, because the draft is diffed against its seed and a shared seed
