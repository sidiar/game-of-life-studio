...
export const cellSelectors: Selectors<CellSubject, CellProperty> = {
  cellState: (cell) => cell.state,
  organismType: (cell) => cell.organismType,
  age: (cell) => cell.age,
  neighborCount: (cell) => cell.neighborCount,
  occupantNeighborCount: (cell) => cell.occupantNeighborCount,
};
