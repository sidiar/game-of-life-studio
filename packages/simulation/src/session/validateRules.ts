...
// makes the clamp `../strategy/conflictPhase.ts` applies wrap a saturated cell to 0 — a newborn.
// `typeof === 'number'` alone also lets `NaN` through, and every comparison against NaN is false,
// so the rule is dead
